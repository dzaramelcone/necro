...
pub fn Stream(comptime Transport: type) type {
    return struct {
        pub fn nextMessage(t: *const Transport, scratch: []u8, logical_off: usize) ParseError!?MessageView {
        ...
        pub fn materializeDataRow(
            ...
            return try row.create(stmt_cache, stmt_idx, render_count, values[0..render_count], pool);
        }
        ...
        fn linearize(t: *const Transport, off: usize, len: usize, scratch: []u8) []const u8 {
